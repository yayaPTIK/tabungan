         ...
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                @if(Auth::user()->role == 1)
                    ...
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="{{route('nasabah')}}">
                            <i class="icon-briefcase"></i><span>Nasabah</span>
                        </a>      
                    </li>  
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="{{route('admin.register')}}">
                            <i class="icon-briefcase"></i><span>Tambah Nasabah</span>
                        </a>      
                    </li>  
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="{{route('admin.report')}}">
                            <i class="icon-briefcase"></i><span>Jumlah Sirkulasi</span>
                        </a>      
                    </li>  
                @else
                    <li class="nav-level">--- Navigation</li>
                    <li class="{{Request::is('admin')? 'active' : ''}} treeview">
                        <a class="waves-effect waves-dark" href="{{route('user.dashboard')}}">
                            <i class="icon-speedometer"></i><span> Dashboard</span>
                        </a>                
                    </li>
                    <li class="nav-level">--- Components</li>
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="{{route('user.detail')}}">
                            <i class="icon-briefcase"></i><span>Detail Pembayaran</span>
                        </a>      
                    </li>  
                @endif
